...
def merge2(A,b,m,e):
    ...
    while i<m and j<e:
        if A[i] <= A[j]:
            ...
            C[n] = A[j];j+=1;n+=1
#""" Альтернативный вариант ф-ии merge. Отличие в том, что этот вариант
#    не создает новый массив, а меняет местами элементы in-place в исходном массиве.
#    пока еще не работает, нужно допилить
# """
