...
const QMetaObject Settings_Form::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Settings_Form.data,
      qt_meta_data_Settings_Form,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Settings_Form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Settings_Form.stringdata0))
        return static_cast<void*>(const_cast< Settings_Form*>(this));
